...
root.minsize(700,500)#setting the size of the
                    #main window
root.title("Delish Pizza")#title of the window


#opening 1st image file
image1 = Image.open("C:\\Users\\balab\\Downloads\\SDEV140_FinalProject\\Pizza1.jpeg")
#resizing the image
image1 = image1.resize((150, 150), Image.Resampling.LANCZOS)
test = ImageTk.PhotoImage(image1)

#opening 2nd image file
image2 = Image.open("C:\\Users\\balab\\Downloads\\SDEV140_FinalProject\\Pizza2.jpeg")
#resizing the image
...
def calc():
    ...
    priceOfPizza=len1*10.99#multiplying number of pizza with price of 1
    priceOfHotdog=len2*2.99#multiplying number of hot dogs with price of 1
